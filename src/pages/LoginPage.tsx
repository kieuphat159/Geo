...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-dvh bg-slate-100 grid place-items-center p-4">
      ...
      >
        <h1 className="text-xl font-bold text-slate-900">Đăng nhập hệ thống SOS</h1>
        <p className="mt-1 text-sm text-slate-600">Một cổng chung cho User / Admin / Super Admin.</p>
